	...
	<div class="wrapper">
			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/user/findAll.do?pageNum=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="page">
									<li><a href="${pageContext.request.contextPath}/user/findAll.do?pageNum=${page}&pageSize=${pageInfo.pageSize}">${page}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/user/findAll.do?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/user/findAll.do?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
		...
		<script>
			function changePageSize() {
				...
				//向服务器发送请求，改变没页显示条数
				location.href = "${pageContext.request.contextPath}/user/findAll.do?pageNum=${pageInfo.pageNum}&pageSize="
						+ pageSize;
			}
